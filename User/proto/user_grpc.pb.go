...
type UserserviceClient interface {
	...
	Enable(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Update, error)
}
...
func (c *userserviceClient) Enable(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Update, error) {
	out := new(Update)
	err := c.cc.Invoke(ctx, "/proto.Userservice/Enable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserserviceServer interface {
	...
	Enable(context.Context, *Name) (*Update, error)
...
func (UnimplementedUserserviceServer) Enable(context.Context, *Name) (*Update, error) {
...
func _Userservice_Enable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Userservice/Enable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserserviceServer).Enable(ctx, req.(*Name))
	}
	return interceptor(ctx, in, info, handler)
}
